...
# This module is not part of the Divmod project, but it is Copyright 2003 Amir
# Bakhtiar: amir@divmod.org.  This is free software; you can redistribute it
# and/or modify it under the terms of version 2.1 of the GNU Lesser General
# Public License as published by the Free Software Foundation.
#
# This ruby translation, though, was done by Jeff Hodges
# <jeff@somethingsimilar.com>, so don't go hounding Amir about dev stuff.
require 'set'
